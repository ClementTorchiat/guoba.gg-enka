...
async function loadGameData() {
    ...
    gameDataPromise = (async () => {
        ...
        const CACHE_KEY = 'guoba_gamedata_idb_v5';
...
function renderHome() {
    ...
    if (profiles.length === 0) {
        profilesContentHtml = `
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; opacity: 0.5; margin: 80px 0;">
                <img src="${ICON_BASE_PATH}icon_score.webp" alt="" style="width: 64px; height: 64px; margin-bottom: 20px; filter: grayscale(100%);">
        ...
        <div class="recent-account-card-wrapper" onclick="document.getElementById('uidInput').value = '${p.uid}'; fetchUserData();">
            ...
            <div class="player-profile-card" style="margin: 0; width: 100%; height: 100%; box-sizing: border-box; pointer-events: none;">
                ...
                <div class="player-profile-content">
                    <img class="player-profile-avatar" src="${p.pic}" alt="${t('ui.alt.avatar')}" onerror="this.src='https://enka.network/ui/UI_AvatarIcon_PlayerBoy_Circle.png'" decoding="async">
        ...
        profilesContentHtml = `
            <div style="display: flex; flex-wrap: wrap; gap: 20px; margin-left: 20px; margin-right: 20px;">
                ${cardsHtml}
            </div>
        `;
    }
    ...
    container.innerHTML = `
        <div style="padding-left: 20px; padding-right: 20px; padding-top: 40px; display: flex; flex-direction: column; min-height: calc(100vh - 80px);">
            ...
            <div style="border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 24px; margin-top: 40px;">
            ...
            <div class="links" style="display: flex; flex-direction: row; margin-bottom: 48px; gap: 8px; align-items: center;">
                ...
                <a class="link-button-coffee" href="https://ko-fi.com/guobagg" target="_blank" rel="noopener noreferrer">
                  <img src="/assets/global/kofi.webp" alt="${t('ui.alt.kofi')}" width="20" height="20">${t('ui.coffee')}
                </a>    
