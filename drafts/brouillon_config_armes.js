...
const CHARACTER_CONFIG = {
    "Mavuika": {
        ...
        // Noms exacts en Français (tels qu'affichés en jeu)
        bestWeapons: ["Signatures", "Espadon cornurerres"],
        goodWeapons: ["Ossature du dragon", "Trancheuse de roche-noire", "Ombre marémotrice"]
    },
    "Neuvillette": {
        ...
        bestWeapons: ["Tome du flux éternel"],
        goodWeapons: ["Jade sacrificiel", "Malice (Prototype)"]
    },
    "Raiden Shogun": {
        ...
        bestWeapons: ["Lumière du faucheur"],
        goodWeapons: ["La Prise", "Lance de Favonius"]
    },
    "HuTao": {
        ...
        bestWeapons: ["Bâton d'Homa"],
        goodWeapons: ["Fléau du dragon", "Scion de la victoire"]
    },
    "Furina": {
        ...
        bestWeapons: ["Splendeur des eaux tranquilles"],
        goodWeapons: ["Croc suppurant", "Passeur du fleuve cendré", "Désir toxique"]
    },
    "Arlecchino": {
        weights: {
            "critRate_": 1, "critDMG_": 1,
        ...
        bestWeapons: ["Semblance de la lune écarlate"],
        goodWeapons: ["Lance de jade ailée", "Bâton d'Homa", "Scion de la victoire"]
    },
};