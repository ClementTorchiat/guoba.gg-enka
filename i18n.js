(function () {
    ...
    const T = {
        ...
        fr: {
            ...
            "badge.nilou.name": "Sceau du Créateur",
            "badge.nilou.desc": "Vous avez placé Nilou dans votre vitrine. Le créateur du site valide officiellement vos excellents goûts.",
        ...
        en: {
            ...
            "badge.nilou.name": "Creator's Seal",
            "badge.nilou.desc": "You have Nilou in your showcase. The site creator officially approves of your excellent taste.",
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (versionEl) {
            versionEl.textContent = window.t('ui.version', '1.1.7', '6.6');
        }
    });
